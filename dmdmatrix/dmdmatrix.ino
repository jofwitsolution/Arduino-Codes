...
void ShowClockNumbers( unsigned int uiTime, byte bColonOn )
{
   ...
   dmd.drawChar(  1,  0,'0'+((uiTime%10000)/1000), GRAPHICS_NORMAL );   // thousands
   dmd.drawChar(  8,  0, '0'+((uiTime%1000) /100),  GRAPHICS_NORMAL );   // hundreds
   dmd.drawChar( 17,  0, '0'+((uiTime%100)  /10),   GRAPHICS_NORMAL );   // tens
   dmd.drawChar( 25,  0, '0'+ (uiTime%10),          GRAPHICS_NORMAL );   // units
   if( bColonOn )
